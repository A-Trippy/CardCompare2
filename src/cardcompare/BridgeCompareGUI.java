 ...
 * @author DSTIGANT
 */
public class BridgeCompareGUI extends CardCompareGUI {
    ...
    protected void createGraphicalObjects(CardCompareModel m, int w, int h) {
        ...
        BridgeTrickComparator comp = (BridgeTrickComparator) m.getComparator();
        ...
        DefaultGraphicalObject trumpGO = new DefaultGraphicalObject( 300, 30 );
        g = trumpGO.getGraphics();
        g.setColor( Color.BLACK );
        GraphicsUtilityFunctions.drawStringWithFontInRectangle( g,
                suit + " trump", FONT, 0, 0, 300, 30 );
        getObjectContainer().addObject( trumpGO, w/2 - 150, h*7/10 + 35);
